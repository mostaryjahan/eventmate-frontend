...
export const UserProfileDialog = ({ user, open, onOpenChange }: { user: UserInfo; open: boolean; onOpenChange: (open: boolean) => void }) => {
  return (
      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-end gap-2 pt-4">
            ...
            <Button variant="outline" className="text-primary border border-primary"><UserRoundCheck />Follow</Button>
          </div>
        </div>
      </DialogContent>
    </Dialog>
