          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <CardDescription className="flex items-center gap-2 mt-2">
                <button onClick={() => setDialogOpen(true)} className="bg-none hover:underline hover:text-blue-500">
                  {event._count?.participants || 0} Participants
                </button>
              </CardDescription>
            </div>
            <Button variant="ghost" size="icon" className="h-8 w-8 text-gray-500 hover:text-[#a11f65]">
